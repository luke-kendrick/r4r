...
**Guess Who**  
**Your task:** You have been given a data set containing information about a group of people. You will use RStudio to inspect, modify, and filter the data set before investigating a series of clues and identify mystery people within the data.
...
You've just imported your data file. Before we start playing Guess Who, let's investigate what information we have about our group of people.  
...
Answer the following questions. The drop down will turn **green if correct** and **red if incorrect.**  

**Question 2.1: How many variables does this data set have?**  
-choose an answer-

**Question 2.2: Which variable would you use to find out where someone is from?**  
-choose an answer-
...
**Time to investigate!**  
We now know what information we have about our group. Let's use RStudio to find our more...

Answer the following questions. The drop down will turn **green if correct** and **red if incorrect.**  

**Question 5.1: I'm trying to find someone who studies Law. How many people in the data set study Law? Adapt the code above to find the answer.**  
-choose an answer-

**Question 5.2: I've changed my mind... I now want to find someone who studies Psychology. How many people study Psychology?**  
-choose an answer-

## Exercise 6: Guess Who?

**Now let's play Guess Who!**  
We've explored the data set, organised our information, and learned how to find people who match certain characteristics. It's time to put those skills to the test.
...
Use what you have learned above and adapt your code to play GUESS WHO? Each of the following questions gives you clues about a person. Use RStudio to work out who we are looking for!

**Question 6.1: Use the clues below to find the name of the mystery person:**  
...
**Question 7.1: What is the name of the person with the lowest maths score?**  
-choose an answer-  

**Question 7.2: What is the name of the person with the highest total enjoyment score?**  
-choose an answer-
...
**Now we've identified some individuals in the group. Let's now zoom out and investigate the group as a whole.**   
**Question 8.1: How many people in the data set did not say that they own a pet?**  
-choose an answer-
...
Look through the output in the console (bottom left panel) and answer the following questions about this group of people:  
**Question 9.1: What was the mean maths enjoyment score across the data set?**  
-choose an answer- 

**Question 9.2: What is the range for total enjoyment score across the dataset?**  
-choose an answer-  

**Question 9.3: When you look across the three subjects (maths, science, art), which had the highest mean enjoyment score?**  
-choose an answer-  
...
**Question 10.1: How many coffees were drunk by the person from Canterbury and is studying medicine?**  
-choose an answer-

**Question 10.2: What is the name of the person from London, has a hamster, studies Psychology, and did not drink coffee?**  
-choose an answer-
...
**Below are three optional GUESS WHO questions requiring you to fix the code to find the mystery person!**

**Bonus question 1: Fix the code below to find the name of the mystery person:**  
...
**Bonus question 3: Fix the code below to see how many students study law and are from London.**  
``` r
mydata %>% 
